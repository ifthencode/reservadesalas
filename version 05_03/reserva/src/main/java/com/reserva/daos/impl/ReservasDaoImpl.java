...
public class ReservasDaoImpl extends GenericDao implements ReservasDao {
	...
	public List<Object[]> getReservasFecha() {
			Query q = entityManager.createQuery(
					...
					+ " WHERE s.idsala= f.sala_id and f.fecha= :fecha"
					);
	...
	public List<Object[]> getReservasDisponible() {
			Query q = entityManager.createQuery(
					"SELECT s.nombre, f.fecha, f.hora,u.nombre, u.apellidos ,f.idfechahora,s.idsala FROM FechasHorasEntity f, SalasEntity s,UsuarioEntity u"
