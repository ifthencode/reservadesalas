...
import com.reserva.salas.service.impl.SalasServiceImpl;
import com.reserva.salas.service.impl.UsuarioServiceImpl;
...
public class UsuarioController {
	...
	@RequestMapping(value={"/a", "/logina"}, method = RequestMethod.GET)
	...
	public ModelAndView viewNewUser() throws SQLException{
		...
		modelAndView.addObject("listRoles",salaService.getSalas());
		return modelAndView;
	}
	 ...
	 * ModelAndView(); modelAndView.setViewName("admin/viewListUser"); //obtenemos
	 * los usuarios que sean del tipo estudiante
	 * modelAndView.addObject("listUsers",usuarioService.getUsuarios(2L)); return
	 * modelAndView; }
	 */
	
	/*
	 * @RequestMapping(value="/viewListTeacher", method = RequestMethod.GET) public
	 * ModelAndView viewListTeacher(){ ModelAndView modelAndView = new
	 * ModelAndView(); //obtenemos los usuarios que sean del tipo profesor
	 * modelAndView.addObject("listUsers",usuarioService.getUsuarios(3L));
	 * modelAndView.setViewName("admin/viewListUser"); return modelAndView; }
	 */
	 ...
	 * public ModelAndView deleteUser(@RequestParam("idChecked") List<String>
	 * idUsuario){ ModelAndView modelAndView = new ModelAndView(); if
	 * (idUsuario!=null && idUsuario.size()>0) { for (String username:idUsuario)
